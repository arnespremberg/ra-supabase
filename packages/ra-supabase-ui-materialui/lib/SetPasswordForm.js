            ...
            return (React.createElement(React.Fragment, null,
                React.createElement("form", { onSubmit: handleSubmit, noValidate: true },
                    React.createElement("div", { className: classes.form },
                        ...
                        React.createElement("div", null,
                            React.createElement(react_final_form_1.Field, { id: "confirm_password", name: "confirm_password", type: "password", component: Input_1.Input, label: translate('ra-supabase.auth.confirm_password', { _: 'Confirm password' }), disabled: submitting }))),
