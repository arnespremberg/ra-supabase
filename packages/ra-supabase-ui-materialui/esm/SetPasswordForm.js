...
export var SetPasswordForm = function (props) {
    var classes = useStyles(props);
    var translate = useTranslate();
    var access_token = useSupabaseAccessToken();
    var onSuccess = props.onSuccess, onFailure = props.onFailure;
    var setPassword = useSetPassword({ onSuccess: onSuccess, onFailure: onFailure });
    ...
    var submit = function (values) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setPassword({
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement("form", { onSubmit: handleSubmit, noValidate: true },
                    React.createElement("div", { className: classes.form },
                        ...
                        React.createElement("div", null,
                            React.createElement(Field, { id: "confirm_password", name: "confirm_password", type: "password", component: Input, label: translate('ra-supabase.auth.confirm_password', { _: 'Confirm password' }), disabled: submitting }))),
